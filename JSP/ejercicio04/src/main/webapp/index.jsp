...
<html>
    <head>
        ...
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootst\
              rap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1\
              T" crossorigin="anonymous">
        <link href="https://fonts.googleapis.com/css?family=Great+Vibes&display=swap" rel="stylesh\
              eet">
        <style>
            h1 {
    ...
    <body>
                    ...
                    <div class="carrito">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="elimina.jsp?codigo=<%= e.getProducto().getCodigo()%>" class="btn b\

                                   tn-warning text-white">
                                    Eliminar
                                </a>
                            </div>
                        </div>
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.7/umd/popper.min.js" in\
                tegrity="sha384-UO2eT0CpHqdSJQ6hJty5KVphtPhzWj9WO1clHTMGa3JDZwrnQq4sF86dIHNDz0W1" crossorigin=\
        "anonymous"></script>
        <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integ\
                rity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="an\
        onymous"></script>
    </body>
</html>